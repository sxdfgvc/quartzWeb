    ...
    <el-row :gutter="24">
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <div style="font-size: 20px;text-indent: 2em;padding: 0px;">CoffeeWx是一款基于VUE、Spring
            Boot的前后端分离的微信公众号管理系统、支持多公众号。
          </div>
          <h3>技术</h3>
          <ol>
            <li> 开发语言：Java</li>
              ...
              <tr class="userinfo-row">
                ...
                <td class="userinfo-content">
                  <span v-for="item in roles" :key="item"
                        style="display: inline-block;margin-right: 5px">{{ item }}</span>
                </td>
              </tr>
              <tr class="userinfo-row">
                <td class="userinfo-lable">
        ...
        <el-card>
          ...
          <div align="center">
            <img style="width: 300px;margin:0 auto;"
                 src="https://timgsa.baidu.com/timg?image&quality=80&size=b10000_10000&sec=1554283598&di=1465c474061c23800a000bd53284a0ec&src=http://imgup02.iefans.net/iefans/2018-12/14/10/15447556537899_1.jpg">
          </div>
        </el-card>
      </el-col>
    </el-row>
